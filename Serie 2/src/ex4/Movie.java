...
/**
   ...
   the Movie objects. A movie consists of:
     - The movie title
...
public class Movie {
  ...
  private Movie(String title, int year, List<String> directors,
  ...
  */
  ...
  /**
    Loads the movie database and instantiates the Movie objects.
